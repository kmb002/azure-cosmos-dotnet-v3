    ...
    internal class ClientContextCore : CosmosClientContext
    {
            ...
            RequestInvokerHandler requestInvokerHandler = null)
        {
            ...
            return new ClientContextCore(
                ...
                fullTextScoreStatsCache: clientOptions.FullTextScoreStatsCacheTtl.HasValue ?
                new FullTextScoreStatsCache(clientOptions.FullTextScoreStatsCacheTtl.Value, serializerCore) :
                null);
        }
