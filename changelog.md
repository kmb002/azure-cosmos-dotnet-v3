...
- Query: Adds configurable client-side caching for global `FullTextScore` statistics to improve repeated hybrid-search query performance when `FullTextScoreScope.Global` is used (preview).
